...
const UpdateProduct = () => {
    ...
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `https://springboot-ecommerce-v1gh.onrender.com/api/product/${id}`
        );

        setProduct(response.data);
      
        const responseImage = await axios.get(
          `https://springboot-ecommerce-v1gh.onrender.com/api/product/${id}/image`,
          { responseType: "blob" }
        );
  ...
  console.log("formData : ", updatedProduct)
    axios
      .put(`https://springboot-ecommerce-v1gh.onrender.com/api/product/${id}`, updatedProduct, {
        headers: {
